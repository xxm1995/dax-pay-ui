    ...
    >
      <template #title>
        <div :class="`${prefixCls}__popover-title`">
          <Checkbox :indeterminate="indeterminate" v-model:checked="isColumnAllSelected" @change="onColumnAllSelectChange">
          ...
          <Checkbox v-model:checked="isRowSelectionShow" @change="onRowSelectionShowChange" v-if="defaultIsRowSelectionShow">
...
<script lang="ts" setup>
  ...
  const onIndexColumnShowChange = (e: CheckboxChangeEvent) => {
    ...
    props.cache && typeof route.name === 'string' && tableSettingStore.setShowIndexColumn(route.name, e.target.checked)
  }
  ...
  const onRowSelectionShowChange = (e: CheckboxChangeEvent) => {
    ...
    props.cache && typeof route.name === 'string' && tableSettingStore.setShowRowSelection(route.name, e.target.checked)
  }
