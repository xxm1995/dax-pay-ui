<script lang="tsx">
  ...
  import { createPlaceholderMessage, isIncludeSimpleComponents, NO_AUTO_LINK_COMPONENTS, setComponentRuleType } from '../helper'
  ...
  export default defineComponent({
    ...
    setup(props, { slots }) {
      ...
      function renderComponent() {
        ...
        const { renderComponentContent, component, field, changeEvent = 'change', valueField, valueFormat } = props.schema
