<template>
  <basic-drawer showFooter v-bind="$attrs" width="60%" title="现金支付配置" :visible="visible" :maskClosable="false" @close="handleCancel">
...
<script setup lang="ts">
  ...
  import { update, CashConfig, findPayWays, getConfig } from './CashConfig.api'
