<template>
  <basic-drawer showFooter v-bind="$attrs" width="60%" title="储值卡配置" :visible="visible" :maskClosable="false" @close="handleCancel">
...
<script setup lang="ts">
  ...
  import { update, VoucherConfig, findPayWays, getConfig } from './VoucherConfig.api'
