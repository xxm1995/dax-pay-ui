<template>
  <basic-modal defaultFullscreen v-bind="$attrs" :width="750" :visible="visible" @cancel="visible = false">
    <process-viewer
      ref="processViewer"
      :height="750"
      :instance="instance"
...
<script lang="ts" setup>
  ...
  let nodeTaskList = $ref<any>({})
  let flowNodeList = $ref<any>([])
  let bpmModel = $ref<any>({})

  function init(id, isView: boolean) {
    visible = true
    instance = {
