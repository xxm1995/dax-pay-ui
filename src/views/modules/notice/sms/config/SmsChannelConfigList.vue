<template>
  <div class="m-3 p-3 pt-5 bg-white">
      ...
      >
        <template #renderItem="{ item }">
          <a-card hoverable style="width: 200px; margin-bottom: 50px" @click="setting(item)">
            <template #cover>
              <a-image :preview="false" :src="urlPrefix + String(item?.image)" :fallback="fallbackImg" />
            </template>
    ...
    <sms-channel-config-edit ref="smsChannelConfigEdit" @ok="init" />
  </div>
</template>
...
<script lang="ts" setup>
  ...
  let smsChannelConfigEdit = $ref<any>()
  ...
  function setting(info: SmsChannelConfig) {
    smsChannelConfigEdit.show(info)
  }
</script>
