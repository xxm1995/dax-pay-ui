<template>
  <div>
    ...
    <div class="m-3 p-3 bg-white">
      ...
      />
      <ding-robot-config-edit ref="dingRobotConfigEdit" @ok="queryPage" />
    </div>
  </div>
</template>
...
<script lang="ts" setup>
  ...
  const dingRobotConfigEdit = $ref<any>()
  ...
  // 新增
  function add() {
    dingRobotConfigEdit.init(null, FormEditType.Add)
  }
  // 编辑
  function edit(record) {
    dingRobotConfigEdit.init(record.id, FormEditType.Edit)
  }
  // 查看
  function show(record) {
    dingRobotConfigEdit.init(record.id, FormEditType.Show)
  }
