<script setup lang="ts">
  ...
  /**
   * 模拟商户调用 unipay 发起支付
   * 1. 商户端仅签名  2. 浏览器 POST /unipay/pay
   */
  ...
  <div class="develop-trade p-4 pb-28">
    ...
    <a-modal v-model:open="resultVisible" :title="resultModalTitle" :footer="null" :width="640" destroy-on-hidden>
      ...
      <div v-if="!resultSuccess" class="mb-3">
        <a-alert type="error" show-icon :message="resultData.msg || $t('payment.develop.trade.msg.payFail')" />
      </div>
